export default {
  ...
  "user.view.field.id.empty": "User ID is required",
  "user.view.error.not.exists": "User not exists",
  "user.edit.error": "Edit user failed",
  "user.delete.error.admin": "Cannot delete admin user",
  ...
  "role.view.error.not.exists": "Role not exists",
